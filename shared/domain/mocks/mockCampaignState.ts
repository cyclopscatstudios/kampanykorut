...
import { RawAnsweEffectProps, RawEffect } from "../../types/effects";
...
export const campaignState = {
    ...
    "currentQuestion": {
        ...
        "possibleAnswers": [
            {
                "id": "A",
                "label": "This is an answer with id A, and it is a very good answer that will lead to victory."
            },
            {
                "id": "B",
                "label": "This is an answer with id B, and it is a decent answer that will lead to a close defeat."
            },
            {
                "id": "C",
                "label": "This is an answer with id C, and it is a moderately good answer that will lead to a moderate outcome."
            },
            {
                "id": "D",
                "label": "This is an answer with id D, and it is a poor answer that will lead to a defeat."
            }
        ]
    },
